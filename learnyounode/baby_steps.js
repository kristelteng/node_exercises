...
// The first element of the process.argv array is always 'node', and the second element is always the path to your program.js file, 
...
// so you don't need to supply them yourself. To test your program without verifying it, 
// you can invoke it with learnyounode run program.js. When you use run, you are invoking the test environment 
// that learnyounode sets up for each exercise.
